...
def run_for_PDBbind_2016():
    ...
    # create hypergraph
    simplices_to_file(0,4057,10.5,0)      
    
    # compute persistent cohomology
    bar_and_cocycle_to_file(0,4057,10.5,7.5) 
    
    # feature generation
    get_feature_of_train(0,3772,10.5,7.5,0.1) 
    get_feature_of_test(0,285,10.5,7.5,0.1)
    get_target_matrix_of_train()
    get_target_matrix_of_test()
    create_coordinate_with_associated_distance(0,2959)    
    get_cocycle_feature_of_train(0,3772,10.5,7.5,0.1,2.5)
    get_cocycle_feature_of_test(0,285,10.5,7.5,0.1,2.5)    
    get_cocycle_feature_of_train(0,3772,10.5,7.5,0.1,10)
    get_cocycle_feature_of_test(0,285,10.5,7.5,0.1,10)
